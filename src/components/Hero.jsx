            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-10" data-aos="fade-right" data-aos-delay="400">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className={`w-12 h-12 md:w-14 md:h-14 bg-white border border-gray-100 rounded-full flex items-center justify-center text-gray-600 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 ${social.color}`}
