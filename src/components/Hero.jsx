      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center my-auto py-12 relative z-10">
        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <div className="space-y-6">
            <h1 data-aos="fade-right" data-aos-delay="400" className="text-5xl sm:text-6xl md:text-7xl font-bold text-white tracking-tight leading-[1.1]">
              Building modern <br/> web experiences <br/> with <span className="text-[#00D49F] animate-pulse-slow inline-block">clean code</span>
            </h1>
            
            <p data-aos="fade-up" data-aos-delay="600" className="text-lg md:text-xl text-gray-400 max-w-xl leading-relaxed font-light">
          ...
          <div data-aos="fade-up" data-aos-delay="800" className="flex flex-wrap gap-4 pt-4">
            <button
              onClick={(e) => handleScrollTo(e, '#contact')}
              className="px-8 py-3.5 bg-[#00D49F] text-[#0B1115] font-bold rounded-full hover:bg-[#00F0B5] hover:scale-105 transition-all duration-300 flex items-center gap-2 group"
            >
              Get in touch
            ...
            <button
              ...
              className="px-8 py-3.5 bg-transparent text-white border border-white/20 hover:bg-white/5 hover:-translate-y-1 font-semibold rounded-full transition-all duration-300"
            >
              View projects
            </button>
          </div>
